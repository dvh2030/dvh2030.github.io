...
<img src="image.jpg" alt="Het Anker Brewery" width="400">
    ...
    <h1>Welcome to the Het Anker Homepage</h1>
    <p>
        The Het Anker homepage is a delightful place to explore a world of fine Belgian beer and historical charm. Located in Mechelen, Belgium, Het Anker is a renowned brewery with a rich history dating back to the 14th century.
    </p>
    <p>
    ...
    <p>
        Visit the official <a href="https://www.hetanker.be/nl" target="_blank" rel="noopener noreferrer">Het Anker website</a> to start your journey.
    </p>
</body>
</html>
